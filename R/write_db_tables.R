...
populate_db <- function() {
  ...
  group2contrast <- structure(list(group = c("HEK_NoKO_SMG5KD-KD_Z023", "HEK_NoKO_LucKD-KD_Z023",
                                              ...
                                              "U2OS_NoKO_SMG6+SMG7KD-KD", "U2OS_NoKO_LucKD-KD"), contrasts = c("HEK_NoKO_SMG5KD-KD_Z023-vs-HEK_NoKO_LucKD-KD_Z023",
                                                                                                               ...
                                                                                                               "U2OS_NoKO_SMG6+SMG7KD-KD-vs-U2OS_NoKO_LucKD-KD")), row.names = c(NA,
